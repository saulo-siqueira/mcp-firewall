...
export class Firewall {
  ...
  toolCallsHtml() { return shell('Tool Calls', `<h1>Tool Calls</h1><p class="empty">No tool calls recorded yet.</p>`); }
  policiesHtml() { return shell('Policies', `<h1>Policies</h1><p class="empty">No policies configured.</p><button>Create policy</button>`); }
